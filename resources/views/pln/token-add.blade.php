            ...
            <div class="input-form container pt-2 m-3">
                ...
                <div class="input-group">
                    <select name="nominal" class="ml-3 mt-2 border-primary rounded-3">
                        ...
                        <option value="20000" @if (old('bank') == '20000') selected @endif>20.000</option>
                        <option value="50000" @if (old('bank') == '50000') selected @endif>50.000</option>
                        <option value="100000" @if (old('bank') == '100000') selected @endif>10.0000</option>
                        <option value="200000" @if (old('bank') == '200000') selected @endif>200.000</option>
                        <option value="500000" @if (old('bank') == '500000') selected @endif>500.000</option>
                    </select>
                </div>
