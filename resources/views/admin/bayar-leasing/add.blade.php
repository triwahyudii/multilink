        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Bayar Cicilan Leasing</h4>
                </div>
                <form action="{{ url('/admin/bayar-cicilan-leasing/store') }}" method="post">
                    @csrf
                    <div class="d-flex justify-content-center">
                        <div class="input-form container pb-2 m-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="nomor_tagihan" id="nomor_tagihan" class="form-control input m-2 rounded-3" placeholder="Nomor Tagihan">
                            </div>
