        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title fs-3">Setor Tunai</h2>
                </div>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="justify-content-start">
                        <a href="{{ url('/admin/setor-tunai/create') }}" class="btn btn-success btn-sm m-2">
                            <i class="fa-regular fa-plus"></i> Add Data
                        </a>
                        <a href="{{ route('export.setor-tunai') }}" class="btn btn-primary btn-sm m-2">
