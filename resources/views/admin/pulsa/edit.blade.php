                ...
                <form action="{{ url('/admin/pulsa/' . $data['id']) }}" method="post">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="input-form container pb-2 m-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="nomor_handphone" id="nomor_handphone" value="{{ $data['nomor_handphone'] }}" class="form-control input m-2 rounded-3" placeholder="Nomor Handphone">
                            </div>
                            <label class="pt-1">Nominal</label>
                            <div class="input-group">
                                <input type="number" name="pulsa" id="pulsa" value="{{ $data['pulsa'] }}" class="form-control input m-2 rounded-3" placeholder="Nominal">
                            </div>
