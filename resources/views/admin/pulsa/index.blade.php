        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title fs-3">Pulsa</h2>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr>
                                <th>@sortablelink('provider', 'Provider')</th>
                                <th>@sortablelink('nomor_handphone', 'Nomor Handphone')</th>
                                <th>@sortablelink('pulsa', 'Nominal')</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td class="fw-bold">{{ $item['provider'] }}</td>
