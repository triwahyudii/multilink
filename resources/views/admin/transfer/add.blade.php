                ...
                <form action="{{ url('/admin/transfer/store') }}" method="post">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="input-form container pb-2 m-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" class="form-control input m-2 rounded-3" placeholder="Nama Pengirim">
                            </div>
                            ...
                            <div class="input-group">
                                <input type="text" name="nama_penerima" id="nama_penerima" value="{{ old('nama_penerima') }}" class="form-control input m-2 rounded-3" placeholder="Nama Penerima">
                            </div>
                            <label class="pt-1">Nomor Rekening Penerima</label>
                            <div class="input-group">
                                <input type="number" name="nomor_rekening_penerima" id="nomor_rekening_penerima" value="{{ old('nomor_rekening_penerima') }}" class="form-control input m-2 rounded-3" placeholder="Nomor Rekening Penerima">
                            </div>
